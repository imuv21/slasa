            ...
            <section className='pageTwo flexcol center'>
                ...
                <div className='section-con'>
                    ...
                    <div className='flexcol start g5' >
                        ...
                        <h2 className='heading'>Welcome to Herbal Jivan!</h2>
                        <p className='textBig'>At Herbal Jivan, we believe in the power of nature to heal, nourish, and elevate your well-being. Our mission is to provide high-quality herbal products that promote health, wellness, and a balanced life for everyone. We take pride in offering products that harness the ancient wisdom of herbal remedies, crafted with care and precision to support modern lifestyles.</p>
                ...
                <article><h1 className='heading text-center'>Why Choose Herbal Jivan?</h1></article>
                ...
                <div className='join-us-con'>
                    ...
                    <p className=' textBig'>At Herbal Jivan, we’re more than just a company—we’re a community of like-minded individuals who believe in the power of nature to transform lives. Whether you're just beginning your wellness journey or are a seasoned herbal enthusiast, we’re here to support you in achieving your goals.</p>
